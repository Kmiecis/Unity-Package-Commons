...
namespace Common
{
	public static class HexagonUtility
	{
		...
		/// <summary> Convers position defined in hex coordinates to world position </summary>
		...
		/// <summary> Converts position defined as world position to hex coordinates </summary>
